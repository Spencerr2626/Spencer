...
ACQUISITION COSTS (model these): Stamp duty on MOT (progressive 1%/2%/3%/4%, +4-4-8% surcharge if foreign buyer 2026), loan stamp duty (0.5% of loan), legal fees (SPA + loan), valuation. Note RM 1M foreign minimum + MM2H angle.
